        ...
        <Container>
          <div className="max-w-3xl">
            <h1 className="mb-6 text-5xl font-bold leading-tight">
              Malling&Co - Grünerløkka Oslo
            </h1>
            <p className="mb-8 text-xl text-white/90">
              Omfattende placeanalyser og eiendomsinformasjon for Malling&Co sin
              portefølje på Grünerløkka. Utforsk demografi, markedsdata og utviklingstrender
